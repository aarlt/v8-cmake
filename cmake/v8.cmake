...
if (NOT EXISTS "${CMAKE_BINARY_DIR}/deps/v8/BUILD.gn")
  ExternalProject_Add_Step(depot_tools fetch
    COMMAND ${CMAKE_SOURCE_DIR}/cmake/wrap.sh ${CMAKE_BINARY_DIR}/deps/depot_tools fetch v8
    COMMENT "fetch v8"
    DEPENDEES install
  ...
  ExternalProject_Add_Step(depot_tools fetch
    COMMAND ${CMAKE_SOURCE_DIR}/cmake/wrap.sh ${CMAKE_BINARY_DIR}/deps/depot_tools gclient sync
